...
const packages = [
  {
    ...
    link: "/tour-packages/one-day/vrindavan-tour-package",
    popular: false,
  },
  {
    ...
    link: "/tour-packages/one-day/govardhan-barsana-tour",
    popular: false,
  },
  {
    ...
    link: "/tour-packages/two-days/mathura-vrindavan-tour",
    popular: true,
  },
  {
    ...
    link: "/tour-packages/three-days/agra-mathura-vrindavan-tour-package",
    popular: false,
  },
  {
    ...
    link: "/tour-packages/four-days/mathura-vrindavan-agra-tour-package",
    popular: false,
  },
  {
    ...
    link: "/tour-packages/five-days/braj-84-kos-yatra",
    popular: false,
  },
  {
    ...
    link: "/tour-packages/six-days/mathura-vrindavan-ayodhya-varanasi-tour",
    popular: false,
  },
  {
    ...
    link: "/tour-packages/ten-days/mathura-vrindavan-ayodhya-varanasi-chitrakoot-tour-package",
    popular: false,
  },
];
      ...
      <section id="packages" className="py-16 md:py-20 px-5 sm:px-8 bg-[#FFF5EE]">
        <div className="mx-auto max-w-7xl">
              ...
              >
                ...
                <div className="p-5 sm:p-6 flex flex-col flex-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link
                      href={pkg.link}
                      className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center shrink-0 hover:bg-orange-100 transition duration-300"
                    >
          ...
          <div className="text-center mt-10">
            <Link
              href="/tour-packages"
              className="inline-flex items-center gap-2 rounded-full bg-orange-500 px-8 py-3 text-sm font-bold text-white hover:bg-orange-600 shadow-md hover:shadow-lg transition duration-300"
            >
              View All Packages
              <ArrowRight size={16} />
            </Link>
