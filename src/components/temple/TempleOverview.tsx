...
export default function TempleOverview({ TempleData }: { TempleData: any }) {
  return (
    <section className="py-10 md:py-24 bg-[#fff3ea] relative overflow-hidden">

      {/* Decorative glow */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-orange-200 blur-[120px] opacity-40 pointer-events-none" />
      <div className="absolute bottom-20 right-10 w-72 h-72 bg-yellow-200 blur-[120px] opacity-40 pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 relative">

        {/* Heading */}
        <div className="text-center mb-8 md:mb-16">
          <p className="text-amber-500 text-xs tracking-[0.2em] uppercase font-semibold mb-3">
            About This Temple
          </p>
        ...
        {/* Rich HTML content from sunEditor */}
        <div
          className="
            ...
            [&_h2]:text-xl [&_h2]:md:text-2xl [&_h2]:font-bold [&_h2]:text-[#7a2e00] [&_h2]:mb-3
            [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-[#a63d00] [&_h3]:mb-2
          ...
          "
          dangerouslySetInnerHTML={{ __html: TempleData.templeoverview }}
        />
