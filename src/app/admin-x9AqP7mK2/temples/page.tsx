...
const modes = [
  ...
  },
  {
    ...
    description:
      "Create a new temple or content with images, rich text editor, and publish instantly.",
    icon: PlusCircle,
    buttonText: "Add Temple Data",
      ...
      {modes.map((mode, i) => (
        ...
        >
          ...
          <div className="relative h-full rounded-2xl bg-[#0b1220] p-6 border border-white/10 group-hover:border-white/20 transition cursor-pointer">
            ...
            {/* Action Button */}
            <Link href={`/admin-x9AqP7mK2/temples/${mode.route}`}>
              <button
